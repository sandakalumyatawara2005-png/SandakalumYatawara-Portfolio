...
for (let i = 0; i < certItems.length; i++) {
  certItems[i].addEventListener("click", function (event) {
    event.preventDefault();

    certModalImg.src = this.dataset.certSrc;
    certModalImg.alt = this.dataset.certAlt || "Certificate image";
    certModalTitle.innerText = this.dataset.certTitle || "Certificate";
